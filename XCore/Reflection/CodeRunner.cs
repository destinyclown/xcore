...
namespace System.Reflection {
    ...
    public class CodeRunner {
        ...
        public static Object RunFromFile( String filePath ) {
            return RunFullCode(FileEx.Read(filePath));
        }

        public static Object RunSnippetFromFile( String filePath ) {
            return Run(FileEx.Read(filePath));
        }

        public static Object RunFullCode( String code ) {
            String outputName = PathHelper.Map(@"\temp\_xcenter_runTempClass_" + Guid.NewGuid().ToString() + ".exe");
            System.IO.Directory.CreateDirectory(System.IO.Path.GetDirectoryName(outputName));
        ...
        public static Assembly CompileCodeToDll( String code ) {
            ...
            String outputName = @"c:\temp\_xcenter_runTempClass_" + Guid.NewGuid().ToString() + ".dll";
            CodeDomProvider codeDomProvider = GetCodeDomProvider( "c#" );
            CompilerParameters options = new CompilerParameters( new String[] { "System.dll" }, outputName, false );
            options.ReferencedAssemblies.Add( "System.Data.dll" );
            options.ReferencedAssemblies.Add( "System.Drawing.dll" );
        ...
        public static Object Run( String expression ) {
            ...
            builder.Append( "namespace XCore.Reflection {\n" );
            ...
            return ReflectionUtil.CallMethod(results.CompiledAssembly.CreateInstance("XCore.Reflection.__codeRunner"), "run");
        }
