...
namespace System.ORM.Caching {
    ...
    public class CacheTime {
        ...
        public static void updateTable( Type t ) {
            logger.Info( "updateTable at=>" + DateTime.Now + "_" + t.FullName );
        ...
        public static void updateList( String cacheKey ) {
            logger.Info( "updateList at=>" + DateTime.Now + "_" + cacheKey );
